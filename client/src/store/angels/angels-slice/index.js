...
export const fetchFilteredAngels = createAsyncThunk('angels/angels/get', 
    async ({filter, sort}) => {
        ...
        const res = await axios.get(`http://localhost:5000/api/angels/angels/get?${queryParams}`);
        return res?.data;
    }
);
...
export const likeAngel = createAsyncThunk('angels/angels/like', 
    ...
    const res = await axios.post(`http://localhost:5000/api/angels/angels/like/${angelId}`, id, {
...
export const unlikeAngel = createAsyncThunk('angels/angels/unlike', async (id) => {
    console.log(id);
    const res = await axios.post(`http://localhost:5000/api/angels/angels/unlike/${id}`);
    return res?.data;
}
);
export const getLikes = createAsyncThunk('angels/angels/likes', async (id) => {
    const res = await axios.get(`http://localhost:5000/api/angels/angels/likes/${id}`);
    return res?.data;
}
);

export const getAllLikes = createAsyncThunk('angels/angels/allLikes', async () => {
    const res = await axios.get(`http://localhost:5000/api/angels/angels/allLikes`);
    return res?.data;
}
);
...
export const addComment = createAsyncThunk('angels/angels/comments/',
    async (id) => {
        ...
        const res = await axios.post(`http://localhost:5000/api/angels/angels/comments/${angelId}`, id,);
        return res?.data;
    }
);
...
export const getComments = createAsyncThunk('angels/angels/comments/',
    async (id) => {
        const res = await axios.get(`http://localhost:5000/api/angels/angels/comments/${id}`);
        return res?.data;
    } 
);
